...
dbeta3 = Parameter("dbeta3",
                ...
                description="Intermediate testingGR parameter.")
betaPPE0 = Parameter("betaPPE0",
                dtype=float, default=0., label=r"\beta0_{ST}",
                description="PPE 0PN order parameter")

betaPPE0 = Parameter("betaPPE0",
                dtype=float, default=0., label=r"\beta0_{ST}",
                description="PPE 0PN order parameter")
betaPPE1 = Parameter("betaPPE1",
                dtype=float, default=0., label=r"\beta1_{ST}",
                description="PPE 1PN order parameter")
#
# =============================================================================
#
...
testingGR_params = ParameterList\
    ([dchi0, dchi1, dchi2, dchi3, dchi4, dchi5, dchi5l, dchi6, dchi6l,
      ...
      dbeta1, dbeta2, dbeta3,betaPPE0,betaPPE1])
