...
def _check_lal_pars(p):
    ...
    if p['betaPPE0'] is not None:
        lalsimulation.SimInspiralWaveformParamsInsertNonGRBetaPPE0(lal_pars,p['betaPPE0'])
    if p['betaPPE1'] is not None:
        lalsimulation.SimInspiralWaveformParamsInsertNonGRBetaPPE1(lal_pars,p['betaPPE1'])
    return lal_pars
